...
impl Platform {
    ...
    pub fn init<V: crate::viewport::Viewport>(imgui: &mut Context, main_view: &V) -> Platform {
    ...
    pub fn handle_event<T, M: crate::viewport::Manager>(
        &mut self,
        io: &mut Io,
    ...
    fn handle_main_view_event<V: crate::viewport::Viewport>(
        io: &mut Io,
        _viewport: &mut V,
        _cache: &mut Cache,
        event: &WindowEvent,
    ...
    fn handle_window_event<V: crate::viewport::Viewport>(
        io: &mut Io,
        viewport: &mut V,
        cache: &mut Cache,
        event: &WindowEvent,
    ...
    pub fn frame<
        T,
        M: crate::viewport::Manager,
        F: FnOnce(&Ui, Duration),
        S: super::WindowSpawner<M::Viewport>,
    >(
        &mut self,
        imgui: &mut Context,
        manager: &mut crate::viewport::WithLoop<M, T, S>,
        frame: F,
    ) {
...
fn update_monitors<M, T, S>(
    with_loop: &crate::viewport::WithLoop<M, T, S>,
    platform: &mut ImGuiPlatformIO,
) {
